#############################################################################
# Makefile for building: Saigocom.app/Contents/MacOS/Saigocom
# Generated by qmake (3.1) (Qt 6.4.3)
# Project:  Saigocom.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile Saigocom.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Saigocom1.0.0
DISTDIR = /Users/ethan/Documents/GitHub/Saigocom/.tmp/Saigocom1.0.0
LINK          = /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/clang-mac.conf \
		...
		Saigocom.pro  search.cpp
QMAKE_TARGET  = Saigocom
DESTDIR       = 
TARGET        = Saigocom.app/Contents/MacOS/Saigocom
...
EXPORT__PRO_FILE_ = /Users/ethan/Documents/GitHub/Saigocom/Saigocom.pro


include /usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

Saigocom.app/Contents/MacOS/Saigocom:  $(OBJECTS)  
	@test -d Saigocom.app/Contents/MacOS/ || mkdir -p Saigocom.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Saigocom.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/macx.conf \
...
Saigocom.app/Contents/PkgInfo: 
	@test -d Saigocom.app/Contents || mkdir -p Saigocom.app/Contents
	@$(DEL_FILE) Saigocom.app/Contents/PkgInfo
	@echo "APPL????" > Saigocom.app/Contents/PkgInfo
Saigocom.app/Contents/Resources/empty.lproj: 
	@test -d Saigocom.app/Contents/Resources || mkdir -p Saigocom.app/Contents/Resources
	@touch Saigocom.app/Contents/Resources/empty.lproj
	
Saigocom.app/Contents/Info.plist: 
	@test -d Saigocom.app/Contents || mkdir -p Saigocom.app/Contents
	@$(DEL_FILE) Saigocom.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,Cinemint.Saigocom,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},Cinemint.Saigocom,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Saigocom,g" -e "s,@LIBRARY@,Saigocom,g" -e "s,\$${EXECUTABLE_NAME},Saigocom,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >Saigocom.app/Contents/Info.plist

all: Makefile \
		Saigocom.app/Contents/PkgInfo \
		Saigocom.app/Contents/Resources/empty.lproj \
		Saigocom.app/Contents/Info.plist Saigocom.app/Contents/MacOS/Saigocom
...
distdir: FORCE
	...
	$(COPY_FILE) --parents search.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
search.o: search.cpp /usr/local/lib/QtWidgets.framework/Headers/QApplication \
